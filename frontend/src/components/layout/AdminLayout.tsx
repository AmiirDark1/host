...
const navItems = [
  ...
  { href: '/admin/plans', label: 'Plans', icon: ShoppingBag },
...
export function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 left-0 z-40 w-64 bg-gray-900 border-r border-gray-800 transform transition-transform duration-200 ease-in-out lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
